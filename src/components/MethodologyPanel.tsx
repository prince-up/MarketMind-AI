...
export default function MethodologyPanel({ isOpen, onClose }: MethodologyPanelProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-md flex items-center justify-center p-4 z-50 animate-in fade-in duration-300">
      <div 
        className="w-full max-w-2xl bg-neutral-900 border border-neutral-850 rounded-3xl p-6 md:p-8 shadow-2xl relative max-h-[90vh] overflow-y-auto animate-in zoom-in-95 duration-200"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Close Button */}
        <button 
          onClick={onClose}
          className="absolute top-4 right-4 p-2 text-neutral-400 hover:text-white bg-neutral-950 hover:bg-neutral-800 rounded-xl border border-neutral-800 transition-colors"
        >
          <X className="w-5 h-5" />
        </button>
        ...
        <div className="space-y-6 text-sm text-neutral-300 leading-relaxed">
          {/* Section 1 */}
          <div className="p-4 bg-neutral-950 rounded-2xl border border-neutral-800/40">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 text-center">
              <div className="bg-neutral-900/60 p-2.5 rounded-xl border border-neutral-850">
                <div className="text-xs text-neutral-500 font-medium">Financials</div>
                <div className="font-mono font-bold text-white text-base mt-1">30%</div>
              </div>
              <div className="bg-neutral-900/60 p-2.5 rounded-xl border border-neutral-850">
                <div className="text-xs text-neutral-500 font-medium">News</div>
                <div className="font-mono font-bold text-white text-base mt-1">20%</div>
              </div>
              <div className="bg-neutral-900/60 p-2.5 rounded-xl border border-neutral-850">
                <div className="text-xs text-neutral-500 font-medium">Valuation</div>
                <div className="font-mono font-bold text-white text-base mt-1">20%</div>
              </div>
              <div className="bg-neutral-900/60 p-2.5 rounded-xl border border-neutral-850">
                <div className="text-xs text-neutral-500 font-medium">Risk (Inv.)</div>
                <div className="font-mono font-bold text-white text-base mt-1">20%</div>
              </div>
              <div className="bg-neutral-900/60 p-2.5 rounded-xl border border-neutral-850">
                <div className="text-xs text-neutral-500 font-medium">Competitors</div>
                <div className="font-mono font-bold text-white text-base mt-1">10%</div>
              </div>
            </div>
          ...
          <div className="p-4 bg-neutral-950 rounded-2xl border border-neutral-800/40">
            ...
            <ul className="list-disc list-inside mt-2 space-y-1 text-neutral-400">
              <li><strong className="text-neutral-300">Financial Ratios & Valuations:</strong> Yahoo Finance API</li>
              <li><strong className="text-neutral-300">Latest News & Competitor Profiling:</strong> Tavily Search Engine api</li>
              <li><strong className="text-neutral-300">AI Synthesized Recommendations:</strong> Llama 3.3 70B via Groq</li>
            </ul>
          </div>
          ...
          <div className="p-4 bg-rose-500/5 border border-rose-500/10 rounded-2xl flex gap-3">
            ...
            <div>
              <h3 className="font-bold text-white mb-1">Financial Advisory Disclaimer</h3>
