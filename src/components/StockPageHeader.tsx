        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          {onMethodologyOpen && (
            <button
              ...
              className="hidden sm:flex items-center gap-1.5 px-3 py-2 text-xs font-medium text-[#44475b] hover:text-[#00b386] bg-white border border-[#e9e9eb] rounded-lg transition-colors"
            >
