    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-6 text-neutral-200">
      <div className="w-full max-w-md bg-neutral-900 border border-neutral-800 rounded-3xl p-8 shadow-2xl relative overflow-hidden">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-neutral-500 mt-1">Log in to continue your research</p>
        </div>
        ...
        <form className="flex flex-col gap-5">
          ...
          <button 
            formAction={login}
            className="w-full py-3.5 mt-2 bg-white text-black font-bold rounded-xl hover:bg-neutral-200 transition-colors"
          >
            Log In
          </button>
        </form>
